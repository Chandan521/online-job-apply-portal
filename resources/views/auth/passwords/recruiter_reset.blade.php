        ...
        <div class="col-md-6 col-lg-5">
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <h4 class="mb-4 text-center">Recruiter Forgot Password</h4>
                    ...
                    <form method="POST"
                        action="{{ empty($email) ? route('recruiter.password.send_otp') : route('recruiter.password.verify_otp') }}">
                        @csrf
                        ...
                        @else
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{ route('recruiter.password.request', ['email' => $email, 'resend' => 1]) }}"
